...
{
    private const string MediatorName = "SourceMediator";
    ...
    private static void CreateMediator(SourceProductionContext context, ImmutableArray<INamedTypeSymbol?> handlers)
    {
        ...
        sb.AppendLine();
        sb.AppendLine($"public class {MediatorName} : global::Mediator.Contract.IMediator");
        sb.AppendLine("{");
        sb.AppendLine(
            "    private readonly Dictionary<Type, Func<object, CancellationToken, Task<object>>> _handlers = new();");
        sb.AppendLine("    private readonly IServiceProvider _serviceProvider;");
        sb.AppendLine();
        sb.AppendLine($"    public {MediatorName}(IServiceProvider serviceProvider)");
        sb.AppendLine("    {");
